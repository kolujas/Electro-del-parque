<div class="modal fade"
    ...
    aria-hidden="true">
    <form class="maintenance modal-dialog needs-validation contact-form m-auto" role="document" novalidate="novalidate" action="/preguntar" method="post" data-text="El contacto aún no funciona, Si desea enviar un mensaje personalmente hágalo a: electromedicadelparque@gmail.com">
        @csrf
